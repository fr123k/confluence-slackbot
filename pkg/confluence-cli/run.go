...
import (
	...
	// client "github.com/fr123k/confluence-slackbot/pkg/confluence-cli"
)

var restClient *ConfluenceClient

func prepareClient(config *ConfluenceConfig) {
	validateClientDetails(config)
	restClient = Client(config)
}

func validateClientDetails(config *ConfluenceConfig) {
